		...
		<?php
			...
			if (count($listeEtudiants) == 0){
				...
				foreach ($listeEtudiants as $etudiant){
					...
					$script .= '<td><a href="index.php?p=modules&a=listemodules&idetudiant='.$etudiant->getId().'&idpf='.$pf->getId().'" title="Liste des modules"><span class="glyphicon glyphicon-list"></span></a></td>';
					$script .= '<td><a href="index.php?p=evaluations&a=view&idetudiant='.$etudiant->getId().'&idpf='.$pf->getId().'" title="Voir les évaluations"><span class="glyphicon glyphicon-tasks"></span></a></td>';
